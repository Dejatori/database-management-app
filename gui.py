...
class CRUDApp:
    ...
    def __init__(self):
        ...
        self.root = tk.Tk()
        self.root.title("Sistema de Gestión Multibase")
        ...
        title_label = ttk.Label(header_frame, text="Sistema de Gestión Multibase by Dejatori 📝", font=("Helvetica", 16, "bold"))
        ...
        tables_config = {
            'clinica': {
                'Pacientes': {'endpoint': 'clinica/pacientes', 'columns': [
                    ...
                    ('direccion', 'Dirección', 200), ('telefono', 'Teléfono', 100),
                    ('fecha_nacimiento', 'Fecha Nacimiento', 120),
                    ('historial_medico', 'Historial Médico', 300)
                ]},
                'Médicos': {'endpoint': 'clinica/medicos', 'columns': [
                    ('id', 'ID', 50), ('nombre', 'Nombre', 150),
            ...
            'restaurante': {
                ...
                'Empleados': {'endpoint': 'restaurante/empleados', 'columns': [
                    ('id', 'ID', 50), ('nombre', 'Nombre', 150),
                    ('posicion', 'Posición', 150),
                    ('fecha_contratacion', 'Fecha Contratación', 150)
                ]},
            ...
            'automoviles': {
                ...
                'Vehículos': {'endpoint': 'automoviles/vehiculos', 'columns': [
                    ('vin', 'VIN', 150), ('marca', 'Marca', 100),
                    ('modelo', 'Modelo', 100), ('anio', 'Año', 70),
                    ('color', 'Color', 100), ('tipo', 'Tipo', 100),
                    ('precio', 'Precio', 100),
                    ('fecha_recepcion', 'Fecha Recepción', 150)
                ]},
    ...
    def create_clinica_tab(self):
        """
        Crea la pestaña de Clínica con su selector de tabla y contenido.
        """
        clinica_frame = ttk.Frame(self.notebook)
        self.notebook.add(clinica_frame, text='Clínica')
    ...
    def create_restaurante_tab(self):
        """
        Crea la pestaña de Restaurante con su selector de tabla y contenido.
        """
    ...
    def create_automoviles_tab(self):
        """
        Crea la pestaña de Automóviles con su selector de tabla y contenido.
        """
        automoviles_frame = ttk.Frame(self.notebook)
        self.notebook.add(automoviles_frame, text='Automóviles')
